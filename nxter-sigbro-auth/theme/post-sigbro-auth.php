...
do_action('generate_after_entry_header');
    ...
    <div class="nb row" style="margin-bottom: 1rem;">
      <div class="nb col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
        ...
        <div class="nb alert-success" style="padding: 0 10px 0 10px; " id=""><center>Scan this QR code with your SIGBRO app</center></div>
        ...
        <div class="nb alert-info" style="padding: 0 10px 0 10px; " id=""><center>Or <a href="https://nxter.github.io/ARDOR-SigBro-Offline/" target=_blank style="text-decoration: underline;">generate</a> a token for this key: '<?php echo $_SESSION['sigbro_uuid']; ?>' manually.</center></div>
      </div>
    </div>
    ...
    <div class="nb row" style="margin-bottom: 2rem;">
      <div class="nb col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2"  style="margin-top: 10px;">
        <div class="nb input-group">
          ...
          <input type="password" class="nb form-control" id="sigbro_auth--auth_token" placeholder="Enter the generated token here " aria-describedby="basic-addon1">
